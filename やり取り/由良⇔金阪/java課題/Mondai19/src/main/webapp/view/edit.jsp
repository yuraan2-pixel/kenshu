...
<body>
	...
	<form action="/sampleProject/UpdateBook?id=<%=user.getId()%>" method='POST'>
		...
		<br>お気に入り書籍	<br> 
			<input	type='text' name='favoriteBook'	value=	<%=user.getFavoriteBook()%>><br> 
		<br> お気に入りポイント<br>					<textarea cols="35" rows="2"
					type="text" name='detail'>				<%=user.getDetail()%></textarea><br> 
